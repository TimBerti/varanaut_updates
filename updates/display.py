...
def update_companies_display(db):
    ...
    sql = '''
        ...
        SET
            ...
            price_cash_flow = EXCLUDED.price_book,
            price_cash_flow_change = EXCLUDED.price_book_change,
            price_cash_flow_ranker = EXCLUDED.price_book_ranker,
            price_cash_flow_ranker_change = EXCLUDED.price_book_ranker_change,

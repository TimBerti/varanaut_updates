CREATE TABLE companies_display (
    ...
    return_on_capital_arr double precision [],
    ...
    annual_free_cash_flow_change_average double precision,
    annual_free_cash_flow_change_std double precision,
    ...
    ev_ebit_average_10y double precision,
    ev_ebit_deviation_10y double precision,
    ev_ebitda_average_10y double precision,
    ev_ebitda_deviation_10y double precision,
